...
import type { RecurringFrequency, RecurringCategory, RecurringTransaction } from '@/types';
...
export const EditRecurringModal: React.FC<EditRecurringModalProps> = ({ isOpen, onClose, onUpdate, recurringTransaction }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Calculate next due date based on new start date and frequency
        const start = new Date(startDate);
        const nextDue = calculateNextDueDate(start, frequency);

        onUpdate(recurringTransaction.id, {
            type,
            name,
            amount: amountNum,
            frequency,
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-2xl bg-[#1a1a1a] border border-[#d4af37]/30 rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
                <div className="sticky top-0 flex justify-between items-center p-6 border-b border-[#d4af37]/10 bg-gradient-to-r from-[#1a1a1a] to-[#252525] z-10">
                    <h2 className="text-xl font-bold text-[#d4af37] font-serif tracking-wide">Edit Recurring Transaction</h2>
